      ...
      <div className="flex content-center">
        <div className="flex items-center cursor-pointer ml-auto lg:ml-32">
          {/* <img
            ...
            alt=""
          /> */}
          <h3 onClick={() => navigate("/")} className="text-md font-bold opacity-[.70]">
          Harvest <br /> Bridge
          </h3>
        </div>
        <div className="flex-2 w-5/12 mx-auto">
          ...
          <li
            ...
            >
              ...
              <a className="text-lg cursor-pointer font-semibold text-[#219653] hover:opacity-90 ml-6 mr-1.5" href={"http://localhost:3000/"} target="_blank">Visit E-Market</a>
              <a className="text-lg cursor-pointer font-semibold text-[#219653] hover:opacity-90 ml-6 mr-1.5" href={"http://localhost:3001/"} target="_blank">Farm Discuss</a>
              <a className="text-lg cursor-pointer font-semibold text-[#219653] hover:opacity-90 ml-6 mr-1.5" href={"http://localhost:8001/"} target="_blank">Crop Care</a>
              {/* <a className="text-lg cursor-pointer font-semibold text-[#219653] hover:opacity-90 ml-6 mr-1.5" href={"http://localhost:5001/"} target="_blank">Local Market</a> */}
