        ...
        <Flex height="90%" direction={['column', 'row', 'row']}>
          <Box p="2" my={['2rem', '3rem', '5rem']}>
            <Image
              ...
              mx={['40vw', '4vw', '18vw']}
              src="https://res.cloudinary.com/dazfklhla/image/upload/v1680627857/logo_e3qfae.png"
            />
            <Text
            ...
            <Heading
              ...
              textAlign="center"
            >
              A Social Networking Site Exclusively for Farmers and the Agricultural Community
            </Heading>
          </Box>
          <Spacer />
          <Box
